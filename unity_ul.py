        ...
        if not excluded and show_filter:
            if self.show_exclusive: # all of them
                included = (
                    ...
                    (not self.show_bake_rot or item.root_motion_rot_bake_into) and
                    (not self.show_bake_x or item.root_motion_x_bake_into) and
                    (not self.show_bake_y or item.root_motion_y_bake_into) and
                    (not self.show_bake_z or item.root_motion_z_bake_into) and
                    (not self.show_offset_rot or item.root_motion_rot_offset != 0.0) and
                    (not self.show_offset_x or item.root_motion_x_offset != 0.0)
                ...
                included = (
                    ...
                    (self.show_bake_rot and item.root_motion_rot_bake_into) or
                    (self.show_bake_x and item.root_motion_x_bake_into) or
                    (self.show_bake_y and item.root_motion_y_bake_into) or
                    (self.show_bake_z and item.root_motion_z_bake_into) or
                    (self.show_offset_rot and item.root_motion_rot_offset != 0.0) or
                    (self.show_offset_x and item.root_motion_x_offset != 0.0)
