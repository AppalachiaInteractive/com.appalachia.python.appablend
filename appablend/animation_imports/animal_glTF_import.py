...
from appablend.common.imports import import_gltf
from appablend.common.utils import data, files, hierarchy
...
def do_execute():
    ...
    import_gltf(full_glTF_path)

    glTF_directory_files = files.get_files_in_dir(glTF_directory, glTF_file_basename)
    ...
    for parentless_obj in parentless_objs:
        ...
        hierarchy.delete_hierarchy(parentless_obj)
