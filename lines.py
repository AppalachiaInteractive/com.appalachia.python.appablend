...
class LineRenderer:
    ...
    def add_line(self, start, end, color1=(1.0, 0.0, 0.0, 1.0), color2=(1.0, 0.0, 0.0, 1.0)):
    ...
    def add_lines(self, points, start_color=(1.0, 0.0, 0.0, 1.0), end_color=(1.0, 0.0, 0.0, 1.0)):
        ...
        for point_index in range(point_count - 1):
            ...
            first_color = (start_color[0] + (first_time * color_range[0]),
            ...
            second_color = (start_color[0] + (second_time * color_range[0]),
